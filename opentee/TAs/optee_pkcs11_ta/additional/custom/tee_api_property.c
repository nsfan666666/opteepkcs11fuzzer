...
// ? utee_funcs make OP-TEE specific svc calls to lower layers
...
#include <__tee_isocket_defines.h> // #include <tee_isocket.h>
...
// 	case USER_TA_PROP_TYPE_UUID:
// 		// ! from snprintk to snprintf
// 		l = snprintf(value, *value_len, "%pUl", tmp_buf);
// 		break;

// 	case USER_TA_PROP_TYPE_IDENTITY:
// 		p_identity_val = ((TEE_Identity *)tmp_buf);
// 		// ! from snprintk to snprintf
// 		l = snprintf(value, *value_len, "%u:%pUl",
...
// ! NOT SUPPORTED: Open-TEE doesnt provide TEE_GetPropertyAsIdentity (utee syscalls use OP-TEE svc)

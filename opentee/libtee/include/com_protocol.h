...
#define TA_ST_PIPE_PATH "/tmp/tastpipe" 
#define ENGINE_SEM "/engine_sem"
...
/*!
 * \brief send_pid
 * Send a process id over a file descriptor to another process
 * \param fd The file descriptor used
 * \param pid The process id to be sent
 * \return 0 on success, error code otherwise
 */
// ssize_t send_fd_pid(int fd, pid_t pid);

/*!
 * \brief send_status
 * Send a process status over a file descriptor to another process
 * \param fd The file descriptor used
 * \param pid The process status to be sent
 * \return 0 on success, error code otherwise
 */
// ssize_t send_fd_status(int fd, unsigned int pid);

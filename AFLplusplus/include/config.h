...
/* Path to the engine semaphore */

#define ENGINE_SEM "/engine_sem"

/* Path to the pipe for communication between forkserver and engine */

#define TA_ST_PIPE_PATH "/tmp/tastpipe"

/* Path to the socket for Open-TEE */

#define OPENTEE_SOCK "/tmp/open_tee_sock"

/* Path to secure storage used by Open-TEE */

#define SS_PATH "/home/$USER/.TEE_secure_storage"

/* Semaphore for AFL to wait for engine for open FIFO */

#define AFL_ENGINE_SEM "/afl_engine_sem"

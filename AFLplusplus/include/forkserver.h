...
typedef struct afl_forkserver {
  ...
  s32 fsrv_pid,                         /* PID of the fork server           */
      ca_pid,                           /* PID of the CA program            */ // *
      child_pid,                        /* PID of the fuzzed program        */
      engine_pid,                       /* PID of the engine process        */ // *
      ca_status,                     /* waitpid result for the ca     */ // *
  ...
  s32 out_fd,                           /* Persistent fd for fsrv->out_file */
      ...
      ta_st_pipe_fd;                    /* FD for named pipe shared between afl-fuzz (read) and engine/manager (write). Only need one pipe. */ // *
